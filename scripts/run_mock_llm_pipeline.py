...
def seed_mock_jobs_in_cache() -> None:
    ...
    mock_jobs = [
        ...
        Job(
            ...
            description="Developing scalable AI web applications with Python, FastAPI backend, LangGraph, and React/TypeScript frontend.",
            salary_range="$125,000 - $138,000",
            location="Remote",
            apply_url="https://app.comeet.com/jobs/cloudworks/cmt-strong-1",
        ),
        Job(
            job_id="workday-msft-1",
            title="Software Engineer - AI Platform & Cloud Services",
            company="Microsoft",
            source="workday",
            sources=["workday"],
            work_mode=WorkMode.HYBRID,
            ...
            description="Developing intelligent agent workflows, high-throughput FastAPI microservices, and Docker containers on Azure.",
            salary_range="$145,000 - $170,000",
            location="Herzliya",
            url="https://microsoft.wd5.myworkdayjobs.com/en-US/Careers/job/workday-msft-1",
        ),
        Job(
            job_id="eightfold-nvda-1",
            ...
            description="Building generative AI inference pipelines, agentic orchestration, and backend microservices.",
            salary_range="₪38,000 - ₪45,000 / mo",
            location="Yokneam",
            apply_url="https://nvidia.eightfold.ai/careers/job?domain=nvidia.com&pid=eightfold-nvda-1",
        ),
        Job(
            job_id="direct-google-1",
            title="Software Engineer, Cloud AI & Developer Tools",
            company="Google",
            source="direct_tech",
            sources=["direct_tech"],
            work_mode=WorkMode.HYBRID,
            ...
            description="Design next-generation developer tooling, AI integrations, and cloud backend microservices.",
            salary_range="$150,000 - $175,000",
            location="Tel Aviv",
            url="https://www.google.com/about/careers/applications/jobs/results/direct-google-1",
        ),
        Job(
            ...
            description="Join our team building data pipelines, LangGraph agents, FastAPI REST services, Docker containers, and AI application tools.",
            salary_range="₪32,000 - ₪38,000 / mo",
            location="Herzliya",
            url="https://www.alljobs.co.il/job/alljobs-strong-2",
        ),
        Job(
            job_id="linkedin-tech-1",
            ...
            description="Build modern full-stack web applications with Python/FastAPI backends and React/TypeScript frontends.",
            salary_range="$130,000 - $155,000",
            location="Remote, Israel",
            apply_url="https://www.linkedin.com/jobs/view/linkedin-tech-1",
        ),
        Job(
            job_id="hmt-disq-1",
