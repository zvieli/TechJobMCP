...
from hireme_mcp.models.schemas import OperationMode, ToolResponse
...
class TestSetOperationMode:
    ...
    async def test_set_autonomous_mode(self):
        from hireme_mcp.main import set_operation_mode, _operation_mode
...
class TestServerInstructionsAutonomy:
    def test_instructions_mention_autonomous(self):
        from hireme_mcp.main import SERVER_INSTRUCTIONS
